# Business Model Canvas — Foundation & Theory

## Origin & Creator

The Business Model Canvas was created by **Alexander Osterwalder** and **Yves Pigneur**, published in *Business Model Generation* (2010). Osterwalder's PhD dissertation at the University of Lausanne (2004) laid the theoretical groundwork. The book was co-created with 470 practitioners from 45 countries, making it one of the most collaboratively developed business tools.

The **Value Proposition Canvas** was introduced in Osterwalder's follow-up book *Value Proposition Design* (2014), zooming into the Customer Segments and Value Propositions blocks.

---

## The 9 Building Blocks — Theory & Detail
...
## Value Proposition Canvas (VPC) — Theory
